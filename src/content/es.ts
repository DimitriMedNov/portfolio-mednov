    ...
    empleate: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            "Por eso se construyó también un conmutador con inteligencia artificial que contesta la llamada con voz, escucha lo que la persona necesita y la transfiere a la extensión que le corresponde. Quien marca queda atendido desde el primer momento en lugar de esperar a que se desocupe alguien, y así se puede atender a más gente que aplica a las distintas vacantes sin agregar personal a la misma proporción.",
            "Un menú de teclas resuelve el mismo enrutamiento desde hace décadas, pero le pide a la persona que traduzca lo que quiere a un número de una lista que primero tiene que escuchar entera. Contestar con voz le quita ese trabajo a quien llama y se lo pasa al sistema, que ahora tiene que entender a alguien hablando como habla y no como escogería una opción.",
      ...
      honesty: {
        ...
        items: [
          ...
          "No hay exactitud medida del conmutador: no se midió con qué frecuencia entendía bien a quien llamaba ni cuántas llamadas transfería a la extensión equivocada.",
