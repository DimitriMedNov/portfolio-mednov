  ...
  systems: {
    ...
    cases: [
      ...
      },
      {
        ...
        desc: "Plataforma de encuestas completa, con su backend, su panel web y su app móvil de captura en campo. Lo que la sostiene es que una encuesta no se programa sino que se define: las preguntas viven en un catálogo aparte y se reutilizan entre formularios, cada uno decide cuáles son obligatorias y cuáles aparecen sólo si otra se respondió de cierta forma, y tanto el panel como la app dibujan el formulario a partir de esa definición, así que una encuesta nueva se da de alta en la base y no se programa. Las respuestas se guardan con la ubicación desde donde se levantaron, que es lo que permite leer un resultado por zona y no sólo en total. En el backend las consultas se generan con sqlc a partir del SQL, de modo que un cambio de esquema rompe la compilación en vez de fallar en producción, y las migraciones van embebidas en el binario y se aplican al arrancar.",
